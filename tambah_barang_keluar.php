...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="form_penjualan.php" class="btn btn-primary fw-bold shadow-sm">
        ...
        <form method="GET" action="">
            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-4">
                    ...
                    <a href="tambah_barang_keluar.php" class="btn btn-secondary btn-sm"><i class="fa-solid fa-rotate"></i> Reset</a>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped mb-0" width="100%" cellspacing="0">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            <small class="text-muted">
                Halaman <b><?php echo $page; ?></b> dari <b><?php echo $total_pages; ?></b> (Total: <?php echo $total_records; ?>)
            </small>

            <nav>
                <ul class="pagination pagination-sm mb-0">
                    <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                        <a class="page-link" href="<?php if($page <= 1){ echo '#'; } else { echo "?page=".($page-1)."&limit=$limit&tgl_mulai=$tgl_mulai&tgl_selesai=$tgl_selesai"; } ?>">Prev</a>
                    </li>

                    <li class="page-item <?php if($page >= $total_pages){ echo 'disabled'; } ?>">
                        <a class="page-link" href="<?php if($page >= $total_pages){ echo '#'; } else { echo "?page=".($page+1)."&limit=$limit&tgl_mulai=$tgl_mulai&tgl_selesai=$tgl_selesai"; } ?>">Next</a>
                    </li>
                </ul>
            </nav>
        </div>
